...
def build_html(logo, nifty, configs, sim_meta, sim_results, signals_rows, sig_date):
    ...
    # Note: This is a RAW string now. No 'f' prefix. This completely prevents KeyError crashes from CSS/JS braces.
...
<header>
  <div class="hdr">
    ...
    <div class="hdr-right">
      <span class="hdr-badge">&#9679; __GENERATED__</span>
...
<div id="liveBanner">
  &#10003; Last simulation: <strong id="bannerDate">__GENERATED__</strong> &nbsp;|&nbsp; Data date: <strong>__LAST_DATE__</strong>
</div>
...
<div class="cstrip">
  ...
  <input type="date" id="toDate" value="__TODAY_DATE__" style="padding:6px 10px;font-size:12px;min-width:130px;">
...
<div id="tab-configs" class="hidden">
  <div class="card">
    ...
    <div class="table-area">
      ...
      <tbody>__CFG_HTML__</tbody></table>
    </div>
...
const SIGNALS_RAW = __SIGNALS_JS__;
const NIFTY_DATA  = __NIFTY_JS__;
const CONFIGS_DEF = __CONFIGS_JS__;
...
function renderTab(tab){
  ...
  if(!slice.length){
    const emptyMsg=tab==='fe'?
      '<tr><td colspan="13" class="empty">&#10003; No trades approaching Force Exit threshold.</td></tr>':
...
function renderPerformance(){
  ...
  const totalLoss=Math.abs(allExec.reduce((s,r)=>{const p=parseFloat(r.PROFIT)||0;return p
